        ...
        for obsPos in gameState.getHouseWalls(house):
            ...
            for assignment in factor.getAllPossibleAssignmentDicts():
                ...
                if assignment[obsVar] == NO_OBS_VAL:
                    ...
                    no = False
                if obsPos in gameState.getHouseWalls(housePositions[assignment[GHOST_HOUSE_VAR]]):
                    ghost = True
                else:
                    ghost = False
                if obsPos in gameState.getHouseWalls(housePositions[assignment[FOOD_HOUSE_VAR]]):
                    food = True
                else:
                    food = False
                if blue and food:
